...
namespace MakeTablesForLookupInLeanFromTablesTxt
...
public def specs : Array TableSpec := #[
  ...
  ⟨"Script_Name", "ScriptName", #["UnicodeBasicCommon.Types.Script"], "Array (UInt32 × String)", .scriptName⟩,
...
private def renderParentModuleFromSubmodules (spec : TableSpec) (chunkCount : Nat) : String :=
  ...
  String.intercalate "\n" <|
    ["/- This file is generated by table-generators/makeTablesForLookupInLeanFromTablesTxt. -/", "module"] ++
    imports ++
...
end MakeTablesForLookupInLeanFromTablesTxt
