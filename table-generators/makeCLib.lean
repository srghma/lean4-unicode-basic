...
import UnicodeData.Core.PropList
import UnicodeData.Core.PropertyValueAliases
import UnicodeData.Core.Scripts
import UnicodeBasicCommon.Types.Script

open Unicode

def clibDir : System.FilePath := ".."/"lib"/"UnicodeCLib"
